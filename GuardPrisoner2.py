import sys
sys.path.insert(0,"C:\\Users\\ryan.peach\\OneDrive\\Documents\\School\\Masters of Science\\Knowledge-Based AI")
...
def Moved(state1,state2,num):
        ...
        return abs(L-R) == num and state1[BL] != state2[BL]
...
Goal = Frame("Goal", {PL: 0, PR:3, GL: 0, GR: 3, BL: False})

Rule1 = Sentence(Less,(PR,GR)).disj(Eq,(PR,GR))
Rule2 = Sentence(Less,(PL,GL)).disj(Eq,(PL,GL))
...
print generate_and_test(gen, tst, graph, Goal)
